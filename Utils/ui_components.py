...
def leer_archivo_cacheado(
    ...
    su contenido estructurado como DataFrame (para .csv y .xlsx) o como Document (para .docx). El resultado
    se cachea para evitar reprocesamiento redundante.

    Args:
        bytes_archivo (bytes): Contenido binario del archivo.
        tipo (str): Tipo de archivo. Acepta: 'csv', 'xlsx', 'docx'.
...
class FileUploaderManager:
    ...
    def leer_archivos(self) -> List[any]:
        """
